  ...
  return (
    <div className="stats_box">
      <div className="stats_items supply">
        ...
        <span className="stats_items_amount">{TOTAL_SUPPLY}</span>
      ...
      <div className="stats_items staked">
        ...
        <span className="stats_items_amount">{info.total_staked}</span>
      ...
      <div className="stats_items unstaked">
        ...
        <span className="stats_items_amount">{info.total_unstaked}</span>
